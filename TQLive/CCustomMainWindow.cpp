...
void CCustomMainWindow::setResizeable(bool resizeable)
{
...
void CCustomMainWindow::setResizeableAreaWidth(int width)
{
	if (1 > width) width = 1;
	m_borderWidth = width;
}

void CCustomMainWindow::setTitleBar(QWidget* titlebar)
{
	m_titlebar = titlebar;
	if (!titlebar) return;
...
void CCustomMainWindow::onTitleBarDestroyed()
{
...
void CCustomMainWindow::addIgnoreWidget(QWidget* widget)
{
	if (!widget) return;
...
bool CCustomMainWindow::nativeEvent(const QByteArray &eventType, void *message, long *result)
{
...
void CCustomMainWindow::setContentsMargins(const QMargins &margins)
{
	QMainWindow::setContentsMargins(margins + m_frames);
	m_margins = margins;
}

void CCustomMainWindow::setContentsMargins(int left, int top, int right, int bottom)
{
...
QMargins CCustomMainWindow::contentsMargins() const
{
...
void CCustomMainWindow::getContentsMargins(int *left, int *top, int *right, int *bottom) const
{
...
QRect CCustomMainWindow::contentsRect() const
{
...
void CCustomMainWindow::showFullScreen()
{
	if (isMaximized())
	{
		QMainWindow::setContentsMargins(m_margins);
...
//void CCustomMainWindow::showEvent(QShowEvent *event)
//{
//	setResizeable(m_bResizeable);
//}