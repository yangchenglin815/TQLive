...
signals:
	void onSigSourceHandler(OBSSceneItem sceneitem, int type);
...
private:
	...
	VisibilityPushButton *set = nullptr;
	VisibilityPushButton *up = nullptr;
	VisibilityPushButton *down = nullptr;
	VisibilityPushButton *del = nullptr;
...
signals:
	void onSigCreateSourceItem(OBSSceneItem item);
...
public slots:
	...
	void AddGroup();
	void Edit(int idx);
	void onSourceHandler(OBSSceneItem sceneitem, int type);
