...
enum EN_EXIT_STATUS_CODE
{
	kExitRejected
};

class OBSApp : /*public QtSingleApplication*//*public QtSingleCoreApplication,*/ public QApplication{
	Q_OBJECT
...
private:
	...
	EN_EXIT_STATUS_CODE			   m_enExitStatusCode;
public:
	//QtSingleCoreApplication m_singleInstance;
...
public:
	...
	void AppInit();
	bool OBSInit(const QRect &rc = QRect(0, 0, 0, 0));
	...
	void SetProfilerNameStore(profiler_name_store_t *store)
	{
		profilerNameStore = store;
	}

	void SetSleepInhibitor()
	{
		sleepInhibitor = os_inhibit_sleep_create("OBS Video/audio");
	}

	void SetExitStatusCode(EN_EXIT_STATUS_CODE enExitStatusCode)
	{
		m_enExitStatusCode = enExitStatusCode;
	}
...
public slots:
	...
	void slotIMLogout();
	void slotMessageReceived(QString qsMsg);
...
inline OBSApp *App() { return (OBSApp *)qApp;/*static_cast<OBSApp*>(qApp);*/ }
